...
/*
 * $Log: ConstraintBtnsActionListener.java,v $ Revision 1.4 1999/12/16 02:10:01 gjb * java/cda/Makefile.am: Put Constraint/*,
 * Main/* files into the distribution and build with them.
 * 
 ...
 * 
 * Revision 1.3 1998/05/14 23:40:06 gjb Patch from noth to redraw the buttons after they are clicked to fix the disappearing icon
 * bug that appears (only) on linux
 * 
 ...
 * 
 * Revision 1.2 1998/03/27 06:23:34 Michael Added new buttons for relational constraints
 * 
