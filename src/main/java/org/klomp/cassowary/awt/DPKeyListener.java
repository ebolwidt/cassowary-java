...
public final class DPKeyListener extends KeyAdapter implements KeyListener {
    ...
    public void keyReleased(KeyEvent e) {
        ...
        case KeyEvent.VK_S: // Query size of DrawPanel
            ...
            System.out.println("DrawPanel size is " + d.width + ", " + d.height);
            break;
...
/*
 * $Log: DPKeyListener.java,v $ Revision 1.3 1999/12/16 02:10:01 gjb * java/cda/Makefile.am: Put Constraint/*, Main/* files into
 ...
 * 
 * Revision 1.2 1998/04/15 00:09:58 Michael Added keyboard shortcuts to create CC's and anchor, coloc. constrs
 * 
 * Revision 1.1 1998/04/01 10:16:41 Michael Shortened names
 * 
 * Revision 1.3 1998/03/27 06:24:52 Michael Added code to allow picking a target CC for relational constraints
 * 
