...
public class ImageButton extends Button {
    ...
    public void setImg() {
        ...
        System.out.println("IB.setImg done, DocBase = " + ((Applet) parentApp).getDocumentBase());
    ...
    public void update(Graphics g) {
        ...
        /*
         * // boolean dIResult = g.drawImage(img, 1, 1, bgColor, ibio); boolean dIResult = g.drawImage(img, 1, 1, ibio);
         */
    }
...
/*
 * $Log: ImageButton.java,v $ Revision 1.3 1999/12/16 02:10:02 gjb * java/cda/Makefile.am: Put Constraint/*, Main/* files into the
 ...
 * 
 * Revision 1.7 1998/03/27 06:23:57 Michael Set label of image buttons to none to prevent annoying flicker
 * 
 ...
 * 
 * Revision 1.1 1998/02/12 07:55:02 Michael ImageButton helper class, first check-in
 */
