...
public class MainPanelComponentListener extends ComponentAdapter implements ComponentListener {
    ...
    public void componentResized(ComponentEvent e) {
        ...
        /*
         * System.out.println("MPCl.cR requesting drawPanel dims (" + d.width + ", " + d.height + ")");
         */
        if (d.width < 100)
            d.width = 100;
        if (d.height < 100)
...
/*
 * $Log: MainPanelComponentListener.java,v $ Revision 1.3 1999/12/16 02:10:02 gjb * java/cda/Makefile.am: Put Constraint/*, Main/*
